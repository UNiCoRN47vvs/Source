...
//-------------------------------------------------------------------------------------------------------------
void UCPPW_Inventory::NativeConstruct()
{
	...
	int temp_inventory_slots = player_character->GetInventoryComponent()->Max_Inventory_Slots;
	int temp_mis_per_row = player_character->GetInventoryComponent()->MIS_Per_Row;
	for (int i = 0; i < temp_inventory_slots; i++)
	{
